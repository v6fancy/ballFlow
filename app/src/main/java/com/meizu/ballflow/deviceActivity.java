...
import com.meizu.ballflow.MainActivity.ServerOrCilent;
	...
	private void init() {
		...
		serviceButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				MainActivity.serviceOrCilent=ServerOrCilent.SERVICE;
				Intent rebootActionIntent = new Intent(mContext, BallCross.class);
		...
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			StopDialog.setPositiveButton("连接", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					...
					MainActivity.serviceOrCilent=ServerOrCilent.CILENT;
//					MainActivity.serviceOrCilent=ServerOrCilent.SERVICE;
					Intent rebootActionIntent = new Intent(mContext, BallCross.class);
					rebootActionIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					mContext.startActivity(rebootActionIntent);
